...
export function Toast() {
  ...
  return (
    <div role="status" aria-live="polite"
      className="no-imprimir sombra-2 fixed inset-x-4 top-4 z-40 mx-auto flex max-w-[400px] items-center gap-2 rounded-[var(--raio-cartao)] border border-ok/40 bg-panel px-3.5 py-3">

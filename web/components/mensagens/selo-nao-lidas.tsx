...
export function SeloNaoLidas({ quantidade }: { quantidade: number }) {
  ...
  return (
    <span
      ...
      className="inline-flex h-5 min-w-5 shrink-0 items-center justify-center rounded-[var(--raio-pilula)] bg-crit px-1.5 font-mono-instr text-[11px] font-semibold tabular-nums text-ink"
    >
      {rotulo}
    </span>
  )

...
export function SituacaoVerified({
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center whitespace-nowrap rounded-full border px-2.5 py-0.5 font-mono-instr text-[11px] tracking-wide ${ESTILO[selo.situacao]} ${className}`}
    >
      {texto}
    </span>
  )

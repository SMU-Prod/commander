...
export function SituacaoVerified({
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center whitespace-nowrap rounded-[var(--raio-pilula)] border px-2.5 py-0.5 tabular-nums text-xs tracking-wide ${ESTILO[selo.situacao]} ${className}`}
    >
      {texto}
    </span>
  )

...
export function SeloGold({
  ...
  return (
    <span className={`inline-flex flex-col items-center gap-1.5 ${className}`}>
      ...
      {mostrarPlaca && (
        <span className="flex flex-col items-center rounded-md border border-accent-forte/40 bg-accent/10 px-2 py-1 text-center tabular-nums text-xs leading-tight text-accent-forte">

...
-- Renumerada de 038 para 039 no merge: a onda 39 (marketplace) usou 038 em
-- paralelo, e duas migrations com o mesmo numero confundem a ordem de
-- aplicacao em qualquer ambiente novo. O SQL ja foi aplicado no banco remoto
-- com o nome antigo; renumerar aqui so acerta a ORDEM do arquivo, nao muda o
-- que roda. Licao: onda paralela reserva numero de migration antes de comecar.
